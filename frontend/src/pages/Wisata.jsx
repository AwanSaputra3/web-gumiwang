...
const categories = [
  ...
  { value: 'petualangan', label: 'Petualangan', emoji: '🚣' },
...
const DEFAULT_WISATA_LIST = [
  {
    ...
    fasilitas: ["Pemandu", "Pakan Ikan", "Modul Belajar", "Toilet"],
  ...
  },
  {
    ...
    satuanHarga: "per orang",
    fasilitas: ["Spot Foto", "Gazebo", "Pemandu", "Area Cuci"],
  ...
  },
  {
    ...
    fasilitas: ["Bahan Baku", "Alat Masak", "Instruktur", "Ruang Bersih"],
  ...
  },
  {
    ...
    satuanHarga: "per orang",
    fasilitas: ["Pelampung & Helm", "Pemandu Lapangan", "Dokumentasi", "Teh Hangat"],
  ...
  },
  {
    ...
    fasilitas: ["Toilet & Kamar Mandi", "Sewa Tenda", "Api Unggun", "Keamanan 24 Jam"],
  ...
  },
  {
    ...
    "fasilitas": ["Area Parkir", "Meja Makan Taman", "Live Music Akustik", "Mushola"],
  ...
  },
  {
    ...
    "satuanHarga": "per orang",
    "fasilitas": ["Panggung Pentas", "Alat Musik Gamelan", "Kostum Tari", "Instruktur Seni"],
  ...
  },
  {
    ...
    "hargaFormatted": "Rp 15.000",
    "satuanHarga": "per orang",
    "fasilitas": ["Keranjang Petik", "Topi Caping", "Keran Air Bersih", "Timbangan"],
...
function Wisata() {
  ...
  useEffect(() => {
    async function fetchWisata() {
      ...
      // Fallback filter
      if (activeCategory) {
        setWisataList(DEFAULT_WISATA_LIST.filter(item => item.kategori.toLowerCase() === activeCategory.toLowerCase()));
      } else {
        setWisataList(DEFAULT_WISATA_LIST);
      }
      setLoading(false);
    }
    fetchWisata();
